...
@Index("<CEI_DRT_PK>", ["drtCodcia", "drtCodctc", "drtCodent", "drtAnireq", "drtCodreq", "drtAniuso", "drtEntuso", "drtEspuso", "drtCoddre"], { unique: true })
...
export class Cei_Drt_Det_Entity {
    ...
    drtValpre?: string;
    @PrimaryColumn()
    @Column("number", { name: "DRT_CODDRE", precision: 4, scale: 0, })
    drtCoddre?: number;
}
